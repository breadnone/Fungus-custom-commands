...
namespace Fungus
{
    ...
    [AddComponentMenu("")]
    public class CharacterZoomFlip : Command
    {
        ...
        [SerializeField] protected Vector3 moveCharacterUI = new Vector3(1f, 1f, 1f);
        ...
        protected bool moveIsCompleted = false; protected bool moveIsCompleted1 = false; protected bool moveIsCompleted2 = false; protected bool moveIsCompleted3 = false;        
            ...
            if (character && character.State.portraitImage != null)
            {
                if (cacheChar != null)
                {
                    ...
                    for (int i = 0; i < cacheChar.Count; i++)
                    {
                        ...
                        if (flipCharacter)
                        {
                            LeanTween.scale(c, new Vector3(-scaleCharacterUI.x, scaleCharacterUI.y, scaleMoveDuration), scaleMoveDuration).setEase(easeType).setOnComplete(() =>
                                {
                                    Continues();
                                });                          
                        }
